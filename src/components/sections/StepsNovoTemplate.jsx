        ...
        <div className="mx-auto w-full">
          <div className="grid lg:grid-cols-2 gap-2 desktop1:gap-16 items-center">
            ...
            <div className="order-1 lg:order-2 space-y-12">
                ...
                {steps.map((item, idx) => (
                  <MotionDivDownToUp>
                    <div key={idx} className="flex gap-6 relative">
                      ...
                      <div className="pt-2">
                        <h1
                          className={`text-xl font-bold mb-2 font-secondFont text-center ${text}`}
                        >
                          {item.cardTitle}
                        </h1>
                        <p
                          className={`text-sm font-light font-secondFont text-center ${textOpacity}`}
                        >
              ...
              {showGlobalButtonsLps && (
                <MotionDivDownToUp>
                  <div className="desktop1:flex flex-col gap-4 pt-4 w-fit justify-center items-center hidden">
                    <ButtonReflexo
                      icon={
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
