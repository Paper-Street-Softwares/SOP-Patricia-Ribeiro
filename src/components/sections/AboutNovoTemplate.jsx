        ...
        <section className="w-full relative overflow-visible">
            ...
            <div className="grid lg:grid-cols-2 gap-0 desktop1:gap-16 items-center">
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <MotionDivDownToUp>
                    <p
                      className={`font-secondFont font-light text-sm tablet1:text-lg leading-relaxed mt-6 text-center ${textOpacity}`}
                    >
                  ...
                  <MotionDivDownToUp>
                    {ButtonModal && (
                      <Button
                        onClick={onClick}
                        className={`bg-transparent mt-4 border-none shadow-primary/20 font-secondFont py-0 uppercase font-bold transition-all px-0 scale-100 hover:scale-95 duration-500 outline-none flex items-center mx-auto gap-2 ${textDestaque}`}
                      >
          ...
          >
            <div className="text-paragraph3 px-4 pb-4 flex flex-col">
              <p
                className={`mt-[15px] mb-[20px] text-center ${textOpacityModal}`}
              >
              ...
              <ButtonReflexo
                ...
                className={`clickevent w-fit mx-auto`}
              />
            </div>
          </Dialog>
        </section>
