    ...
    return (
      <AccordionPrimitive.Header className="flex">
        <AccordionPrimitive.Trigger
          ...
          {...props}
          className={cn(
            "group flex flex-1 items-center justify-center gap-2 py-6 font-mainFont text-lg font-medium transition-colors",
            textBase,
            hoverText,
            activeText,
...
const AccordionContent = React.forwardRef(
  ({ className, children, ...props }, ref) => (
    ...
    >
      <div className="pb-6 pt-0 text-center">{children}</div>
    </AccordionPrimitive.Content>
  ),
);
